...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "test/dummy/fixtures/authlogic_users.yml",
    "test/dummy/fixtures/devise_users.yml",
    "test/dummy/models/authlogic/user.rb",
    "test/dummy/models/authlogic/user_session.rb",
    "test/dummy/models/cms_content.rb",
    "test/dummy/models/devise/user.rb",
    "test/dummy/stylesheets/app.css",
    "test/dummy/stylesheets/rich_cms.css",
    "test/dummy/views/application/index.html.erb",
    "test/dummy/views/layouts/application.html.erb",
    ...
    "test/rails-2/dummy/config/initializers/config.rb",
    ...
    "test/rails-3/dummy/config/initializers/config.rb",
    ...
    "test/support/action_controller/integration.rb",
    "test/support/action_controller/test_case.rb",
    "test/support/capybara/setup.rb",
    "test/tests/actionpack/action_controller/base_test.rb",
    "test/tests/actionpack/action_view/base_test.rb",
    "test/tests/activesupport/active_support/dependencies_test.rb",
    "test/tests/app/integration_test.rb",
    "test/tests/app/routing_test.rb",
    "test/tests/content/group.rb",
    "test/tests/content/item.rb",
    "test/tests/core/string/html_safe.rb",
    "test/tests/engine_test.rb",
    "test/tests/rails/engine_test.rb",
    "test/tests/readme_test.rb",
    "uninstall.rb"
  ]
  ...
  s.test_files = [
    ...
    "test/tests/app/integration_test.rb",
    "test/tests/app/routing_test.rb",
    "test/tests/auth/engine_test.rb",
    "test/tests/content/group.rb",
    "test/tests/content/item.rb",
    "test/tests/core/string/html_safe.rb",
    "test/tests/engine_test.rb",
